...
public class Constant {
	...
	public final static String NEW = "new"; //1
	public final static String REVIEW = "review"; //2
	public final static String REQUEST_UPDATE = "request_update"; //3
	public final static String UPDATED = "updated"; //4
	public final static String FINISH = "finish";   //5
	public final static String CANCEL = "cancel";   //6
	public final static String CLOSE = "close";     //0
