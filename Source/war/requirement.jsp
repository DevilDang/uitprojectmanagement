				...
				<div class="Columns">
					...
					<div class="Column2">
						...
						<div class="BlockBorder">
							...
							<div class="Block">
								...
								<span class="BlockHeader"><span> <logic:equal
											value="2" name="record_sort" property="level">
						...
						Chỉnh sửa
										...
										</logic:equal> <logic:notEqual value="2" name="record_sort" property="level">
						Thông tin chi tiết
			</logic:notEqual>
								</span></span>
								<div class="BlockContentBorder">
								...
								Mã yêu cầu:<br>
												<span style='color: red'><bean:write name="req"
														property="id" /></span>
												<br>
											</logic:equal>
										</logic:present>
Tên yêu cầu:<br>
										<html:text property="nameReq" size="22"></html:text>
										<br>
Nhóm thực hiện:<br>
										<logic:equal name="req" property="mode" value="2">
											<html:select property="idGroup"
												...
												<logic:notEqual value="2" name="record_sort"
													property="level">
												</logic:notEqual>
											</html:select>
											<br>
...
Mô tả: <br>
										...
										<br>
Ngày bắt đầu: <br>
										<html:text property="startDate" styleId="datepicker"
											styleClass="validated"></html:text>
										<br>
Ngày kết thúc: <br>
										<html:text property="endDate" styleId="datepicker1"
											styleClass="validated"></html:text>
										<br>
										<logic:equal name="req" property="mode" value="2">
Tiến độ: <br>
