						...
						<div class="BlockBorder">
							...
							Nhóm thực hiện: <select name="group" id="box"
										...
										Loại công việc: <select name="kind" id="box"
											...
											<!-- TestCase -->
											<logic:equal value="TestCase" name="record_sort"
												property="kind">
											...
											<!-- UseCase -->
											<logic:equal value="UseCase" name="record_sort"
												property="kind">
											...
											<!-- BanGiao -->
											<logic:equal value="BanGiao" name="record_sort"
												property="kind">
										...
										</select><br> Trạng thái: <select name="status" id="box"
											onChange="getListTask(4,1)">
										...
										</select><br> <br> Trang:<select name="page" id="select_page"
							...
							<div class="Block">
								...
								<div class="BlockContentBorder">
									<logic:present name="UserLogIN">
										<ul>
											<li><bean:write name="UserLogIN" /><a href="logout.do"><span>(Đăng
														Xuất)</span></a></li>
										</ul>
									</logic:present>
								</div>
					...
					<div class="Column2">
						...
						<div class="BlockBorder">
							...
							<div class="Block">
								...
								<span class="BlockHeader"><span> <logic:equal
											value="3" name="record_sort" property="level">
						...
						Chỉnh sửa
										...
										</logic:equal> <logic:notEqual value="3" name="record_sort" property="level">
						Thông tin chi tiết
			</logic:notEqual>
								</span></span>
								<div class="BlockContentBorder">
								...
								Mã công việc:<br>
												<span style='color: red'><bean:write name="task"
														property="id" /></span>
												<br>
											</logic:equal>
										</logic:present>
Tên công việc:<br>
										<html:text property="nameTask" size="22"></html:text>
										<br>
Loại công việc:<br>
...
Người thực hiện:<br>
										...
										<html:select property="emailEmployee">
											<option
												value="<bean:write name="task" property="emailEmployee"/>">
												<bean:write name="task" property="emailEmployee" />
											</option>
											<logic:equal value="Open" name="record_sort"
												property="status">
												<logic:equal value="3" name="record_sort" property="level">
...
Mô tả: <br>
										...
										<br>
Ngày bắt đầu: <br>
										<html:text property="startDate" styleId="datepicker"></html:text>
										<br>
Ngày kết thúc: <br>
										<html:text property="endDate" styleId="datepicker1"></html:text>
										<br>
										<logic:equal name="task" property="mode" value="2">
Tiến độ: <br>
											<html:text property="process"></html:text>
											<br>
Trình trạng: <br>
											<span style='color: red'><bean:write name="task"
													property="statusTask" /></span>
											<br>
											<logic:equal name="task" property="statusTask"
												value="Đang trễ">
Số ngày trễ: <br>
												<span style='color: red'><bean:write name="task"
														property="lateDate" /></span>
												<br>
											</logic:equal>
Trạng thái:<br>
									...
									<table id="table_task_list" cellspacing="0" cellpadding="0"
										...
										<thead>
											<tr align="center">
												...
												<td width="70"><b>Mã công việc</b></td>
													...
													<tr align="center">
														...
														<td width="70"><b><a
																href="/displayTask.do?id=<bean:write name="item" property="id"/>"><bean:write
																		name="item" property="id" /> </a> </b></td>
														<td width="130"><b><bean:write name="item"
																	property="nameTask" /> </b></td>
														<td width="130"><b><bean:write name="item"
