		...
		<div id="content">
									...
									<logic:iterate id="element" name="org_list">
										<tr align="center">
											<td width="20"><input type="checkbox" name="checkall"
												id="checkall" onClick="checkUncheckAll(this);" /></td>
											<td width="70"><b><a
													href="/displayOrg.do?id=<bean:write name="element"  property="idOrg"/>"><bean:write
															name="element" property="idOrg" /></a></b></td>
											<td width="130"><b><bean:write name="element"
														property="nameOrg" /></b></td>
											<td width="130"><b><bean:write name="element"
														property="addOrg" /></b></td>
										</tr>
									</logic:iterate>
								</logic:present>
							</tbody>
			...
			<html:form action="/updateOrg.do" method="get">
				<div id="content_right">
					...
					<h3 align="center">
						<!-- <a href="/changeMode.do?mode=2"> -->
						Chỉnh sửa </a> / <a href="/changeMode.do?mode=1">Thêm mới </a>
					</h3>
					<br>
					<table id="table_monhoc" class="table_right" cellspacing="5"
						...
						<logic:present name="flagOrg">
							<logic:equal name="flagOrg" value="2">
								<tr>
									...
									<td width="300"><bean:write name="organization"
											property="idOrg" /></td>
								</tr>
							</logic:equal>
						</logic:present>
						...
						<tr>
							<td>Tên đối tác:</td>
							<td><html:text property="nameOrg" /></td>
						</tr>
						<tr>
							<td width="100">Địa Chỉ:</td>
							<td width="300"><html:text property="addOrg" /></td>
						</tr>
						<tr>
							<td>Website:</td>
							<td><html:text property="websiteOrg" /></td>
						</tr>
						<tr>
							<td>Số Điện thoại:</td>
							<td><html:text property="numberOrg" /></td>
						</tr>
					</table>
					<table>
						<tr>
